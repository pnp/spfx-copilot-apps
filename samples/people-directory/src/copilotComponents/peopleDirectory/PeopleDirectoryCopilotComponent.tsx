...
import type { IPeopleDirectoryProps } from './components/IPeopleDirectoryProps';
import type { IPeopleDirectoryCopilotComponentProperties } from './PeopleDirectoryCopilotComponentProperties';

import * as strings from 'PeopleDirectoryCopilotComponentStrings';
 ...
 */
export default class PeopleDirectoryCopilotComponent extends BaseCopilotComponent<IPeopleDirectoryCopilotComponentProperties> {
  ...
  protected render(): void {
    const props: IPeopleDirectoryProps = {
      message: this.properties.message,
      inputQuery: this.properties.inputQuery,
    ...
    ReactDOM.render(React.createElement(PeopleDirectory, props), this.context.domElement);
  }
