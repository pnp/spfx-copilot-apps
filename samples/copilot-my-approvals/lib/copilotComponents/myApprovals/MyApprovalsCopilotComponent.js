...
import { ApprovalService, getPhotoDataUrl } from './core/ApprovalService';
...
var MyApprovalsCopilotComponent = /** @class */ (function (_super) {
    __extends(MyApprovalsCopilotComponent, _super);
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        _a = this;
                        return [4 /*yield*/, getPhotoDataUrl(graphClient, '/me/photos/64x64/$value')];
                    case 4:
                    ...
                    case 6:
                        _e.trys.push([6, 9, , 10]);
                        return [4 /*yield*/, this.context.spHttpClient.get("".concat(this._siteUrl, "/_api/web?$select=Title"), SPHttpClient.configurations.v1)];
                    case 7:
                        response = _e.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        approvalService = new ApprovalService(this.context.msGraphClientFactory);
    ...
    MyApprovalsCopilotComponent.prototype.render = function () {
        ...
        var props = {
            ...
            onRequestDisplayMode: function (mode) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
            ...
            onRequestSizeChange: function (width, height) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
...
export default MyApprovalsCopilotComponent;
